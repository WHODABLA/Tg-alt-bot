#!/usr/bin/env python3
"""
TG-Lion Market Bot — NOWPayments Edition
Multi-language · Single-message navigation · D1 storage · Invoice cleanup
"""
...
LANGUAGES = {
    "en": {
        "name": "English", "flag": "🇬🇧",
        "welcome": "Your Balance", "select_option": "Select an option from the menu below:",
        "browse_desc": "Browse and purchase verified Telegram accounts.",
        "features": "Instant delivery · Secure checkout · 24/7 support",
        "browse_accounts": "Browse Accounts", "wallet": "Wallet", "my_orders": "My Orders",
        "profile": "Profile", "language": "Language", "support": "Support",
        "admin_panel": "🛠 Admin Panel", "back_home": "Back to Home", "back_avail": "Back to availability",
        "back_admin": "🛠 Back to Admin", "available_inventory": "Available inventory",
        "select_country": "Select a country to view live quantity and submit a request.",
        "showing_page": "Page {page} of {total} · Showing {shown} of {total_c} countries",
        "enter_qty": "Enter Custom Quantity", "price_per_account": "Price per account",
        "available_stock": "Available stock", "tap_qty": "Tap below to enter your desired quantity.",
        "send_qty": "Send the quantity you want to purchase as a number.", "example_3": "Example: 3",
        "your_wallet": "Your Wallet", "balance": "Balance", "tap_deposit": "Tap Deposit Funds to add balance.",
        "deposit_funds": "Deposit Funds", "enter_amount": "Enter the amount you want to deposit as a number.",
        "minimum": "Minimum", "example_5": "Example: 5", "select_network": "Select your network:",
        "amount": "Amount", "you_deposit": "You deposit", "total_to_send": "Total to send",
        "send_exactly": "Send exactly", "address": "Address", "payment_id": "Payment ID",
        "fee_notice": "Includes ~{pct}% processing fee (covers network + conversion costs).",
        "send_correct_network": "Send on the correct network only.", "invoice_valid": "Invoice valid for 60 minutes.",
        "credit_notice": "Your balance will be credited automatically within 1–3 minutes.",
        "copy_address": "Copy Address", "check_status": "Check Status", "your_orders": "Your orders",
        "no_orders": "No orders yet", "no_orders_desc": "Browse availability to start a request.",
        "status": "Status", "profile_title": "Profile", "name": "Name", "id": "ID",
        "user_status": "Status", "active": "✅ Active", "banned": "🚫 Banned",
        "order_summary": "🛒 Order Summary", "country": "Country", "quantity": "Quantity",
        "total_price": "Total Price", "your_balance": "Your Wallet Balance",
        "sufficient": "✅ Sufficient", "insufficient": "❌ Insufficient",
        "confirm_purchase": "✅ Confirm Purchase", "change_quantity": "Change Quantity",
        "account_s": "account(s)", "click_confirm": "Click 'Confirm Purchase' to complete your order.",
        "not_enough": "You don't have enough balance. Please deposit funds first.",
        "purchasing": "Purchasing {qty} number(s) from {country}...", "please_wait": "Please wait.",
        "numbers_purchased": "✅ Numbers Purchased", "order_id": "Order ID", "total_paid": "Total Paid",
        "your_numbers": "Your Numbers", "click_get_code": "Click '📩 Get Code' to fetch the login code for each number.",
        "get_code": "📩 Get Code", "get_code_n": "📩 Get Code for #{n}",
        "view_my_orders": "View my orders", "fetching_code": "Fetching code for",
        "code_received": "✅ Code Received for Account #{n}", "number": "Number", "code": "Code",
        "password": "Password", "code_login": "Login to Telegram with this number, then use the code and password above.",
        "retry": "🔄 Retry", "failed": "Failed", "language_title": "🌍 Select your language",
        "language_set": "✅ Language changed to {name}", "deposit_confirmed": "✅ Deposit Confirmed!",
        "new_balance": "New Balance", "admin_title": "🛠 Admin Panel", "total_users": "Total Users",
        "banned_users": "Banned Users", "total_orders": "Total Orders", "total_deposits": "Total Deposits",
        "total_spent": "Total Spent", "total_profit": "Total Profit", "user_balances": "User Balances (owed)",
        "profit_margin": "Profit Margin", "select_action": "Select an action below:",
        "admin_users": "👥 Users", "admin_orders": "📦 Orders", "credit_user": "💳 Credit User",
        "debit_user": "💸 Debit User", "ban_user": "🚫 Ban User", "unban_user": "✅ Unban User",
        "set_margin": "📊 Set Profit Margin", "broadcast": "Broadcast",
        "credit_prompt": "Send in format:\n<code>user_id amount</code>\n\nExample: <code>123456789 5</code>",
        "debit_prompt": "Send in format:\n<code>user_id amount</code>\n\nExample: <code>123456789 2</code>",
        "ban_prompt": "Send the user ID to ban.", "unban_prompt": "Send the user ID to unban.",
        "margin_prompt": "Current: <b>{pct}%</b>\n\nSend the new margin as a percentage.\nExample: <code>50</code> for 50%",
        "broadcast_prompt": "Send the message to broadcast.\n\nUse <code>&lt;emoji:ID&gt;</code> to embed a premium emoji.",
        "invalid_input": "Invalid input.", "invalid_amount": "Invalid amount.", "invalid_quantity": "Invalid quantity.",
        "min_deposit_err": "Minimum deposit is {amount}.", "session_expired": "Session expired. Start over.",
        "unauthorized": "❌ Unauthorized.", "banned_msg": "🚫 You are banned from using this bot.",
        "code_failed": "Failed to fetch code", "error_service": "The service is temporarily unavailable.",
        "invoice_expired": "Your deposit invoice expired",
        "start_over": "Tap 'Deposit Funds' in the Wallet to start a new one.",
    },
    "hi": {
        "name": "हिन्दी", "flag": "🇮🇳",
        "welcome": "आपका बैलेंस", "select_option": "नीचे दिए गए मेनू से एक विकल्प चुनें:",
        "browse_desc": "सत्यापित Telegram खाते ब्राउज़ करें और खरीदें।",
        "features": "तत्काल डिलीवरी · सुरक्षित चेकआउट · 24/7 सहायता",
        "browse_accounts": "खाते ब्राउज़ करें", "wallet": "वॉलेट", "my_orders": "मेरे ऑर्डर",
        "profile": "प्रोफ़ाइल", "language": "भाषा", "support": "सहायता",
        "admin_panel": "🛠 एडमिन पैनल", "back_home": "होम पर वापस", "back_avail": "उपलब्धता पर वापस",
        "back_admin": "🛠 एडमिन पर वापस", "available_inventory": "उपलब्ध इन्वेंटरी",
        "select_country": "लाइव मात्रा देखने और अनुरोध सबमिट करने के लिए एक देश चुनें।",
        "showing_page": "पृष्ठ {page} / {total} · {shown} / {total_c} देश",
        "enter_qty": "कस्टम मात्रा दर्ज करें", "price_per_account": "प्रति खाता मूल्य",
        "available_stock": "उपलब्ध स्टॉक", "tap_qty": "अपनी इच्छित मात्रा दर्ज करने के लिए नीचे टैप करें।",
        "send_qty": "खरीदने की मात्रा एक संख्या के रूप में भेजें।", "example_3": "उदाहरण: 3",
        "your_wallet": "आपका वॉलेट", "balance": "बैलेंस", "tap_deposit": "बैलेंस जोड़ने के लिए डिपॉज़िट फंड्स टैप करें।",
        "deposit_funds": "फंड्स जमा करें", "enter_amount": "जमा करने की राशि एक संख्या के रूप में दर्ज करें।",
        "minimum": "न्यूनतम", "example_5": "उदाहरण: 5", "select_network": "अपना नेटवर्क चुनें:",
        "amount": "राशि", "you_deposit": "आप जमा करते हैं", "total_to_send": "कुल भेजें",
        "send_exactly": "ठीक इतना भेजें", "address": "पता", "payment_id": "भुगतान आईडी",
        "fee_notice": "~{pct}% प्रोसेसिंग शुल्क शामिल।", "send_correct_network": "केवल सही नेटवर्क पर भेजें।",
        "invoice_valid": "इनवॉइस 60 मिनट के लिए मान्य।", "credit_notice": "आपका बैलेंस 1–3 मिनट में स्वतः जमा हो जाएगा।",
        "copy_address": "पता कॉपी करें", "check_status": "स्थिति जांचें", "your_orders": "आपके ऑर्डर",
        "no_orders": "अभी कोई ऑर्डर नहीं", "no_orders_desc": "अनुरोध शुरू करने के लिए उपलब्धता ब्राउज़ करें।",
        "status": "स्थिति", "profile_title": "प्रोफ़ाइल", "name": "नाम", "id": "आईडी",
        "user_status": "स्थिति", "active": "✅ सक्रिय", "banned": "🚫 प्रतिबंधित",
        "order_summary": "🛒 ऑर्डर सारांश", "country": "देश", "quantity": "मात्रा",
        "total_price": "कुल कीमत", "your_balance": "आपका वॉलेट बैलेंस",
        "sufficient": "✅ पर्याप्त", "insufficient": "❌ अपर्याप्त",
        "confirm_purchase": "✅ खरीद की पुष्टि करें", "change_quantity": "मात्रा बदलें",
        "account_s": "खाता/खाते", "click_confirm": "ऑर्डर पूरा करने के लिए 'खरीद की पुष्टि करें' पर क्लिक करें।",
        "not_enough": "आपके पास पर्याप्त बैलेंस नहीं है। कृपया पहले फंड्स जमा करें।",
        "purchasing": "{country} से {qty} नंबर खरीद रहे हैं...", "please_wait": "कृपया प्रतीक्षा करें।",
        "numbers_purchased": "✅ नंबर खरीदे गए", "order_id": "ऑर्डर आईडी", "total_paid": "कुल भुगतान",
        "your_numbers": "आपके नंबर", "click_get_code": "प्रत्येक नंबर का लॉगिन कोड प्राप्त करने के लिए '📩 कोड प्राप्त करें' पर क्लिक करें।",
        "get_code": "📩 कोड प्राप्त करें", "get_code_n": "📩 नंबर #{n} के लिए कोड प्राप्त करें",
        "view_my_orders": "मेरे ऑर्डर देखें", "fetching_code": "कोड प्राप्त कर रहे हैं",
        "code_received": "✅ खाता #{n} के लिए कोड प्राप्त हुआ", "number": "नंबर", "code": "कोड",
        "password": "पासवर्ड", "code_login": "इस नंबर से Telegram में लॉगिन करें, फिर कोड और पासवर्ड उपयोग करें।",
        "retry": "🔄 पुनः प्रयास", "failed": "विफल", "language_title": "🌍 अपनी भाषा चुनें",
        "language_set": "✅ भाषा बदलकर {name} कर दी गई", "deposit_confirmed": "✅ जमा की पुष्टि हुई!",
        "new_balance": "नया बैलेंस", "admin_title": "🛠 एडमिन पैनल", "total_users": "कुल उपयोगकर्ता",
        "banned_users": "प्रतिबंधित उपयोगकर्ता", "total_orders": "कुल ऑर्डर", "total_deposits": "कुल जमा",
        "total_spent": "कुल खर्च", "total_profit": "कुल लाभ", "user_balances": "उपयोगकर्ता बैलेंस (बकाया)",
        "profit_margin": "लाभ मार्जिन", "select_action": "नीचे एक क्रिया चुनें:",
        "admin_users": "👥 उपयोगकर्ता", "admin_orders": "📦 ऑर्डर", "credit_user": "💳 उपयोगकर्ता को क्रेडिट करें",
        "debit_user": "💸 उपयोगकर्ता से डेबिट करें", "ban_user": "🚫 उपयोगकर्ता को प्रतिबंधित करें",
        "unban_user": "✅ प्रतिबंध हटाएं", "set_margin": "📊 लाभ मार्जिन सेट करें", "broadcast": "प्रसारण",
        "credit_prompt": "प्रारूप:\n<code>user_id amount</code>\n\nउदाहरण: <code>123456789 5</code>",
        "debit_prompt": "प्रारूप:\n<code>user_id amount</code>\n\nउदाहरण: <code>123456789 2</code>",
        "ban_prompt": "प्रतिबंधित करने के लिए उपयोगकर्ता आईडी भेजें।", "unban_prompt": "प्रतिबंध हटाने के लिए उपयोगकर्ता आईडी भेजें।",
        "margin_prompt": "वर्तमान: <b>{pct}%</b>\n\nनया मार्जिन प्रतिशत के रूप में भेजें।\nउदाहरण: <code>50</code>",
        "broadcast_prompt": "प्रसारित करने के लिए संदेश भेजें।\n\nप्रीमियम इमोजी के लिए <code>&lt;emoji:ID&gt;</code> का उपयोग करें।",
        "invalid_input": "अमान्य इनपुट।", "invalid_amount": "अमान्य राशि।", "invalid_quantity": "अमान्य मात्रा।",
        "min_deposit_err": "न्यूनतम जमा {amount} है।", "session_expired": "सत्र समाप्त। फिर से शुरू करें।",
        "unauthorized": "❌ अनधिकृत।", "banned_msg": "🚫 आप इस बॉट का उपयोग करने से प्रतिबंधित हैं।",
        "code_failed": "कोड प्राप्त करने में विफल", "error_service": "सेवा अस्थायी रूप से अनुपलब्ध है।",
        "invoice_expired": "आपका जमा इनवॉइस समाप्त हो गया",
        "start_over": "नया शुरू करने के लिए वॉलेट में 'फंड्स जमा करें' टैप करें।",
    },
    "ru": {
        "name": "Русский", "flag": "🇷🇺",
        "welcome": "Ваш баланс", "select_option": "Выберите пункт меню ниже:",
        "browse_desc": "Просматривайте и покупайте проверенные аккаунты Telegram.",
        "features": "Мгновенная доставка · Безопасная оплата · Поддержка 24/7",
        "browse_accounts": "Аккаунты", "wallet": "Кошелёк", "my_orders": "Мои заказы",
        "profile": "Профиль", "language": "Язык", "support": "Поддержка",
        "admin_panel": "🛠 Админ-панель", "back_home": "На главную", "back_avail": "Назад к наличию",
        "back_admin": "🛠 Назад к админу", "available_inventory": "Доступный запас",
        "select_country": "Выберите страну, чтобы увидеть количество и подать заявку.",
        "showing_page": "Стр. {page} из {total} · {shown} из {total_c} стран",
        "enter_qty": "Введите количество", "price_per_account": "Цена за аккаунт",
        "available_stock": "Доступно", "tap_qty": "Нажмите ниже, чтобы ввести количество.",
        "send_qty": "Отправьте количество числом.", "example_3": "Пример: 3",
        "your_wallet": "Ваш кошелёк", "balance": "Баланс", "tap_deposit": "Нажмите «Пополнить», чтобы добавить баланс.",
        "deposit_funds": "Пополнить", "enter_amount": "Введите сумму пополнения числом.",
        "minimum": "Минимум", "example_5": "Пример: 5", "select_network": "Выберите сеть:",
        "amount": "Сумма", "you_deposit": "Вы пополняете", "total_to_send": "Всего к отправке",
        "send_exactly": "Отправьте ровно", "address": "Адрес", "payment_id": "ID платежа",
        "fee_notice": "Включает ~{pct}% комиссии за обработку.", "send_correct_network": "Отправляйте только в правильной сети.",
        "invoice_valid": "Счёт действителен 60 минут.", "credit_notice": "Баланс зачислится автоматически в течение 1–3 минут.",
        "copy_address": "Копировать адрес", "check_status": "Проверить статус", "your_orders": "Ваши заказы",
        "no_orders": "Заказов пока нет", "no_orders_desc": "Просмотрите наличие, чтобы начать.",
        "status": "Статус", "profile_title": "Профиль", "name": "Имя", "id": "ID",
        "user_status": "Статус", "active": "✅ Активен", "banned": "🚫 Заблокирован",
        "order_summary": "🛒 Сводка заказа", "country": "Страна", "quantity": "Количество",
        "total_price": "Итоговая цена", "your_balance": "Ваш баланс",
        "sufficient": "✅ Достаточно", "insufficient": "❌ Недостаточно",
        "confirm_purchase": "✅ Подтвердить покупку", "change_quantity": "Изменить количество",
        "account_s": "аккаунт(ов)", "click_confirm": "Нажмите «Подтвердить покупку» для завершения.",
        "not_enough": "Недостаточно средств. Пополните баланс.",
        "purchasing": "Покупка {qty} номер(ов) из {country}...", "please_wait": "Подождите.",
        "numbers_purchased": "✅ Номера куплены", "order_id": "ID заказа", "total_paid": "Всего оплачено",
        "your_numbers": "Ваши номера", "click_get_code": "Нажмите «📩 Получить код» для каждого номера.",
        "get_code": "📩 Получить код", "get_code_n": "📩 Код для #{n}",
        "view_my_orders": "Мои заказы", "fetching_code": "Получение кода для",
        "code_received": "✅ Код получен для аккаунта #{n}", "number": "Номер", "code": "Код",
        "password": "Пароль", "code_login": "Войдите в Telegram с этим номером, затем используйте код и пароль.",
        "retry": "🔄 Повторить", "failed": "Ошибка", "language_title": "🌍 Выберите язык",
        "language_set": "✅ Язык изменён на {name}", "deposit_confirmed": "✅ Депозит подтверждён!",
        "new_balance": "Новый баланс", "admin_title": "🛠 Админ-панель", "total_users": "Всего пользователей",
        "banned_users": "Заблокировано", "total_orders": "Всего заказов", "total_deposits": "Всего депозитов",
        "total_spent": "Всего потрачено", "total_profit": "Всего прибыли", "user_balances": "Балансы пользователей",
        "profit_margin": "Маржа", "select_action": "Выберите действие:",
        "admin_users": "👥 Пользователи", "admin_orders": "📦 Заказы", "credit_user": "💳 Пополнить",
        "debit_user": "💸 Списать", "ban_user": "🚫 Заблокировать", "unban_user": "✅ Разблокировать",
        "set_margin": "📊 Установить маржу", "broadcast": "Рассылка",
        "credit_prompt": "Формат:\n<code>user_id amount</code>\n\nПример: <code>123456789 5</code>",
        "debit_prompt": "Формат:\n<code>user_id amount</code>\n\nПример: <code>123456789 2</code>",
        "ban_prompt": "Отправьте ID для блокировки.", "unban_prompt": "Отправьте ID для разблокировки.",
        "margin_prompt": "Текущая: <b>{pct}%</b>\n\nОтправьте новую маржу в %.\nПример: <code>50</code>",
        "broadcast_prompt": "Отправьте сообщение для рассылки.\n\nИспользуйте <code>&lt;emoji:ID&gt;</code> для премиум-эмодзи.",
        "invalid_input": "Неверный ввод.", "invalid_amount": "Неверная сумма.", "invalid_quantity": "Неверное количество.",
        "min_deposit_err": "Минимум {amount}.", "session_expired": "Сессия истекла.",
        "unauthorized": "❌ Не авторизован.", "banned_msg": "🚫 Вы заблокированы.",
        "code_failed": "Ошибка получения кода", "error_service": "Сервис временно недоступен.",
        "invoice_expired": "Счёт на депозит истёк",
        "start_over": "Нажмите «Пополнить» в Кошельке, чтобы создать новый.",
    },
    "ar": {
        "name": "العربية", "flag": "🇸🇦",
        "welcome": "رصيدك", "select_option": "اختر خياراً من القائمة أدناه:",
        "browse_desc": "تصفح واشترِ حسابات Telegram الموثّقة.",
        "features": "تسليم فوري · دفع آمن · دعم 24/7",
        "browse_accounts": "تصفح الحسابات", "wallet": "المحفظة", "my_orders": "طلباتي",
        "profile": "الملف", "language": "اللغة", "support": "الدعم",
        "admin_panel": "🛠 لوحة الإدارة", "back_home": "العودة للرئيسية", "back_avail": "العودة للتوفر",
        "back_admin": "🛠 العودة للإدارة", "available_inventory": "المخزون المتاح",
        "select_country": "اختر دولة لعرض الكمية وتقديم الطلب.",
        "showing_page": "صفحة {page} من {total} · {shown} من {total_c}",
        "enter_qty": "أدخل الكمية", "price_per_account": "السعر لكل حساب",
        "available_stock": "المخزون", "tap_qty": "انقر أدناه لإدخال الكمية.",
        "send_qty": "أرسل الكمية كرقم.", "example_3": "مثال: 3",
        "your_wallet": "محفظتك", "balance": "الرصيد", "tap_deposit": "انقر «إيداع» لإضافة رصيد.",
        "deposit_funds": "إيداع", "enter_amount": "أدخل المبلغ كرقم.",
        "minimum": "الحد الأدنى", "example_5": "مثال: 5", "select_network": "اختر الشبكة:",
        "amount": "المبلغ", "you_deposit": "أنت تودع", "total_to_send": "الإجمالي",
        "send_exactly": "أرسل بالضبط", "address": "العنوان", "payment_id": "معرّف الدفع",
        "fee_notice": "يشمل ~{pct}% رسوم معالجة.", "send_correct_network": "أرسل على الشبكة الصحيحة فقط.",
        "invoice_valid": "الفاتورة صالحة 60 دقيقة.", "credit_notice": "سيُضاف رصيدك تلقائياً خلال 1–3 دقائق.",
        "copy_address": "نسخ العنوان", "check_status": "تحقق من الحالة", "your_orders": "طلباتك",
        "no_orders": "لا طلبات بعد", "no_orders_desc": "تصفح التوفر لبدء طلب.",
        "status": "الحالة", "profile_title": "الملف", "name": "الاسم", "id": "المعرّف",
        "user_status": "الحالة", "active": "✅ نشط", "banned": "🚫 محظور",
        "order_summary": "🛒 ملخص الطلب", "country": "الدولة", "quantity": "الكمية",
        "total_price": "الإجمالي", "your_balance": "رصيدك",
        "sufficient": "✅ كافٍ", "insufficient": "❌ غير كافٍ",
        "confirm_purchase": "✅ تأكيد الشراء", "change_quantity": "تغيير الكمية",
        "account_s": "حساب/حسابات", "click_confirm": "انقر «تأكيد الشراء» لإتمام الطلب.",
        "not_enough": "رصيدك غير كافٍ. أودع أولاً.",
        "purchasing": "جارٍ شراء {qty} من {country}...", "please_wait": "يرجى الانتظار.",
        "numbers_purchased": "✅ تم شراء الأرقام", "order_id": "معرّف الطلب", "total_paid": "المدفوع",
        "your_numbers": "أرقامك", "click_get_code": "انقر «📩 الحصول على الرمز» لكل رقم.",
        "get_code": "📩 الحصول على الرمز", "get_code_n": "📩 الرمز لـ #{n}",
        "view_my_orders": "طلباتي", "fetching_code": "جارٍ إحضار الرمز لـ",
        "code_received": "✅ تم استلام الرمز للحساب #{n}", "number": "الرقم", "code": "الرمز",
        "password": "كلمة المرور", "code_login": "سجّل في Telegram بهذا الرقم ثم استخدم الرمز وكلمة المرور.",
        "retry": "🔄 إعادة", "failed": "فشل", "language_title": "🌍 اختر لغتك",
        "language_set": "✅ تم تغيير اللغة إلى {name}", "deposit_confirmed": "✅ تم تأكيد الإيداع!",
        "new_balance": "الرصيد الجديد", "admin_title": "🛠 لوحة الإدارة", "total_users": "إجمالي المستخدمين",
        "banned_users": "المحظورون", "total_orders": "إجمالي الطلبات", "total_deposits": "إجمالي الإيداعات",
        "total_spent": "إجمالي المصروف", "total_profit": "إجمالي الربح", "user_balances": "أرصدة المستخدمين",
        "profit_margin": "هامش الربح", "select_action": "اختر إجراءً:",
        "admin_users": "👥 المستخدمون", "admin_orders": "📦 الطلبات", "credit_user": "💳 إضافة رصيد",
        "debit_user": "💸 خصم رصيد", "ban_user": "🚫 حظر", "unban_user": "✅ إلغاء الحظر",
        "set_margin": "📊 تعيين الهامش", "broadcast": "بث",
        "credit_prompt": "أرسل بالصيغة:\n<code>user_id amount</code>\n\nمثال: <code>123456789 5</code>",
        "debit_prompt": "أرسل بالصيغة:\n<code>user_id amount</code>\n\nمثال: <code>123456789 2</code>",
        "ban_prompt": "أرسل معرّف المستخدم للحظر.", "unban_prompt": "أرسل معرّف المستخدم لإلغاء الحظر.",
        "margin_prompt": "الحالي: <b>{pct}%</b>\n\nأرسل الهامش الجديد بنسبة مئوية.\nمثال: <code>50</code>",
        "broadcast_prompt": "أرسل الرسالة للبث.\n\nاستخدم <code>&lt;emoji:ID&gt;</code> لإيموجي مميز.",
        "invalid_input": "إدخال غير صالح.", "invalid_amount": "مبلغ غير صالح.", "invalid_quantity": "كمية غير صالحة.",
        "min_deposit_err": "الحد الأدنى {amount}.", "session_expired": "انتهت الجلسة.",
        "unauthorized": "❌ غير مصرح.", "banned_msg": "🚫 أنت محظور.",
        "code_failed": "فشل جلب الرمز", "error_service": "الخدمة غير متاحة مؤقتاً.",
        "invoice_expired": "انتهت صلاحية فاتورة الإيداع",
        "start_over": "انقر «إيداع» في المحفظة لبدء واحدة جديدة.",
    },
    "es": {
        "name": "Español", "flag": "🇪🇸",
        "welcome": "Tu saldo", "select_option": "Selecciona una opción del menú:",
        "browse_desc": "Explora y compra cuentas de Telegram verificadas.",
        "features": "Entrega instantánea · Pago seguro · Soporte 24/7",
        "browse_accounts": "Explorar cuentas", "wallet": "Cartera", "my_orders": "Mis pedidos",
        "profile": "Perfil", "language": "Idioma", "support": "Soporte",
        "admin_panel": "🛠 Panel de admin", "back_home": "Volver al inicio", "back_avail": "Volver a disponibilidad",
        "back_admin": "🛠 Volver a admin", "available_inventory": "Inventario disponible",
        "select_country": "Selecciona un país para ver cantidad y enviar una solicitud.",
        "showing_page": "Página {page} de {total} · {shown} de {total_c} países",
        "enter_qty": "Ingresar cantidad", "price_per_account": "Precio por cuenta",
        "available_stock": "Stock disponible", "tap_qty": "Toca abajo para ingresar la cantidad.",
        "send_qty": "Envía la cantidad como número.", "example_3": "Ejemplo: 3",
        "your_wallet": "Tu cartera", "balance": "Saldo", "tap_deposit": "Toca «Depositar» para añadir saldo.",
        "deposit_funds": "Depositar", "enter_amount": "Ingresa el monto como número.",
        "minimum": "Mínimo", "example_5": "Ejemplo: 5", "select_network": "Selecciona tu red:",
        "amount": "Monto", "you_deposit": "Depositas", "total_to_send": "Total a enviar",
        "send_exactly": "Envía exactamente", "address": "Dirección", "payment_id": "ID de pago",
        "fee_notice": "Incluye ~{pct}% de comisión.", "send_correct_network": "Envía solo en la red correcta.",
        "invoice_valid": "Factura válida 60 minutos.", "credit_notice": "El saldo se acreditará en 1–3 minutos.",
        "copy_address": "Copiar dirección", "check_status": "Ver estado", "your_orders": "Tus pedidos",
        "no_orders": "Sin pedidos aún", "no_orders_desc": "Explora disponibilidad para empezar.",
        "status": "Estado", "profile_title": "Perfil", "name": "Nombre", "id": "ID",
        "user_status": "Estado", "active": "✅ Activo", "banned": "🚫 Bloqueado",
        "order_summary": "🛒 Resumen del pedido", "country": "País", "quantity": "Cantidad",
        "total_price": "Precio total", "your_balance": "Tu saldo",
        "sufficient": "✅ Suficiente", "insufficient": "❌ Insuficiente",
        "confirm_purchase": "✅ Confirmar compra", "change_quantity": "Cambiar cantidad",
        "account_s": "cuenta(s)", "click_confirm": "Toca «Confirmar compra» para completar.",
        "not_enough": "Saldo insuficiente. Deposita primero.",
        "purchasing": "Comprando {qty} de {country}...", "please_wait": "Espera por favor.",
        "numbers_purchased": "✅ Números comprados", "order_id": "ID de pedido", "total_paid": "Total pagado",
        "your_numbers": "Tus números", "click_get_code": "Toca «📩 Obtener código» para cada número.",
        "get_code": "📩 Obtener código", "get_code_n": "📩 Código para #{n}",
        "view_my_orders": "Ver mis pedidos", "fetching_code": "Obteniendo código para",
        "code_received": "✅ Código recibido para cuenta #{n}", "number": "Número", "code": "Código",
        "password": "Contraseña", "code_login": "Inicia sesión en Telegram con este número y usa el código y la contraseña.",
        "retry": "🔄 Reintentar", "failed": "Falló", "language_title": "🌍 Elige tu idioma",
        "language_set": "✅ Idioma cambiado a {name}", "deposit_confirmed": "✅ ¡Depósito confirmado!",
        "new_balance": "Nuevo saldo", "admin_title": "🛠 Panel de admin", "total_users": "Total de usuarios",
        "banned_users": "Usuarios bloqueados", "total_orders": "Total de pedidos", "total_deposits": "Total de depósitos",
        "total_spent": "Total gastado", "total_profit": "Total ganado", "user_balances": "Saldos de usuarios",
        "profit_margin": "Margen de ganancia", "select_action": "Selecciona una acción:",
        "admin_users": "👥 Usuarios", "admin_orders": "📦 Pedidos", "credit_user": "💳 Acreditar",
        "debit_user": "💸 Debitar", "ban_user": "🚫 Bloquear", "unban_user": "✅ Desbloquear",
        "set_margin": "📊 Establecer margen", "broadcast": "Difusión",
        "credit_prompt": "Formato:\n<code>user_id amount</code>\n\nEjemplo: <code>123456789 5</code>",
        "debit_prompt": "Formato:\n<code>user_id amount</code>\n\nEjemplo: <code>123456789 2</code>",
        "ban_prompt": "Envía el ID a bloquear.", "unban_prompt": "Envía el ID a desbloquear.",
        "margin_prompt": "Actual: <b>{pct}%</b>\n\nEnvía el nuevo margen en %.\nEjemplo: <code>50</code>",
        "broadcast_prompt": "Envía el mensaje para difundir.\n\nUsa <code>&lt;emoji:ID&gt;</code> para emoji premium.",
        "invalid_input": "Entrada inválida.", "invalid_amount": "Monto inválido.", "invalid_quantity": "Cantidad inválida.",
        "min_deposit_err": "El mínimo es {amount}.", "session_expired": "Sesión expirada.",
        "unauthorized": "❌ No autorizado.", "banned_msg": "🚫 Estás bloqueado.",
        "code_failed": "Error al obtener código", "error_service": "Servicio temporalmente no disponible.",
        "invoice_expired": "Tu factura de depósito expiró",
        "start_over": "Toca «Depositar» en la Cartera para iniciar una nueva.",
    },
    "fr": {
        "name": "Français", "flag": "🇫🇷",
        "welcome": "Votre solde", "select_option": "Sélectionnez une option du menu :",
        "browse_desc": "Parcourez et achetez des comptes Telegram vérifiés.",
        "features": "Livraison instantanée · Paiement sécurisé · Support 24/7",
        "browse_accounts": "Parcourir les comptes", "wallet": "Portefeuille", "my_orders": "Mes commandes",
        "profile": "Profil", "language": "Langue", "support": "Support",
        "admin_panel": "🛠 Panneau admin", "back_home": "Retour à l'accueil", "back_avail": "Retour aux disponibilités",
        "back_admin": "🛠 Retour admin", "available_inventory": "Inventaire disponible",
        "select_country": "Sélectionnez un pays pour voir la quantité et faire une demande.",
        "showing_page": "Page {page} sur {total} · {shown} sur {total_c} pays",
        "enter_qty": "Entrer la quantité", "price_per_account": "Prix par compte",
        "available_stock": "Stock disponible", "tap_qty": "Touchez ci-dessous pour entrer la quantité.",
        "send_qty": "Envoyez la quantité sous forme de nombre.", "example_3": "Exemple : 3",
        "your_wallet": "Votre portefeuille", "balance": "Solde", "tap_deposit": "Touchez « Déposer » pour ajouter du solde.",
        "deposit_funds": "Déposer", "enter_amount": "Entrez le montant sous forme de nombre.",
        "minimum": "Minimum", "example_5": "Exemple : 5", "select_network": "Sélectionnez votre réseau :",
        "amount": "Montant", "you_deposit": "Vous déposez", "total_to_send": "Total à envoyer",
        "send_exactly": "Envoyez exactement", "address": "Adresse", "payment_id": "ID de paiement",
        "fee_notice": "Inclut ~{pct}% de frais de traitement.", "send_correct_network": "Envoyez uniquement sur le bon réseau.",
        "invoice_valid": "Facture valable 60 minutes.", "credit_notice": "Le solde sera crédité en 1–3 minutes.",
        "copy_address": "Copier l'adresse", "check_status": "Vérifier le statut", "your_orders": "Vos commandes",
        "no_orders": "Aucune commande", "no_orders_desc": "Parcourez les disponibilités pour commencer.",
        "status": "Statut", "profile_title": "Profil", "name": "Nom", "id": "ID",
        "user_status": "Statut", "active": "✅ Actif", "banned": "🚫 Banni",
        "order_summary": "🛒 Résumé de la commande", "country": "Pays", "quantity": "Quantité",
        "total_price": "Prix total", "your_balance": "Votre solde",
        "sufficient": "✅ Suffisant", "insufficient": "❌ Insuffisant",
        "confirm_purchase": "✅ Confirmer l'achat", "change_quantity": "Changer la quantité",
        "account_s": "compte(s)", "click_confirm": "Touchez « Confirmer l'achat » pour finaliser.",
        "not_enough": "Solde insuffisant. Déposez d'abord.",
        "purchasing": "Achat de {qty} de {country}...", "please_wait": "Veuillez patienter.",
        "numbers_purchased": "✅ Numéros achetés", "order_id": "ID de commande", "total_paid": "Total payé",
        "your_numbers": "Vos numéros", "click_get_code": "Touchez « 📩 Obtenir le code » pour chaque numéro.",
        "get_code": "📩 Obtenir le code", "get_code_n": "📩 Code pour #{n}",
        "view_my_orders": "Voir mes commandes", "fetching_code": "Récupération du code pour",
        "code_received": "✅ Code reçu pour le compte #{n}", "number": "Numéro", "code": "Code",
        "password": "Mot de passe", "code_login": "Connectez-vous à Telegram avec ce numéro puis utilisez le code et le mot de passe.",
        "retry": "🔄 Réessayer", "failed": "Échec", "language_title": "🌍 Choisissez votre langue",
        "language_set": "✅ Langue changée en {name}", "deposit_confirmed": "✅ Dépôt confirmé !",
        "new_balance": "Nouveau solde", "admin_title": "🛠 Panneau admin", "total_users": "Total des utilisateurs",
        "banned_users": "Utilisateurs bannis", "total_orders": "Total des commandes", "total_deposits": "Total des dépôts",
        "total_spent": "Total dépensé", "total_profit": "Total des bénéfices", "user_balances": "Soldes des utilisateurs",
        "profit_margin": "Marge bénéficiaire", "select_action": "Sélectionnez une action :",
        "admin_users": "👥 Utilisateurs", "admin_orders": "📦 Commandes", "credit_user": "💳 Créditer",
        "debit_user": "💸 Débiter", "ban_user": "🚫 Bannir", "unban_user": "✅ Débannir",
        "set_margin": "📊 Définir la marge", "broadcast": "Diffusion",
        "credit_prompt": "Format :\n<code>user_id amount</code>\n\nExemple : <code>123456789 5</code>",
        "debit_prompt": "Format :\n<code>user_id amount</code>\n\nExemple : <code>123456789 2</code>",
        "ban_prompt": "Envoyez l'ID à bannir.", "unban_prompt": "Envoyez l'ID à débannir.",
        "margin_prompt": "Actuelle : <b>{pct}%</b>\n\nEnvoyez la nouvelle marge en %.\nExemple : <code>50</code>",
        "broadcast_prompt": "Envoyez le message à diffuser.\n\nUtilisez <code>&lt;emoji:ID&gt;</code> pour un emoji premium.",
        "invalid_input": "Entrée invalide.", "invalid_amount": "Montant invalide.", "invalid_quantity": "Quantité invalide.",
        "min_deposit_err": "Le minimum est {amount}.", "session_expired": "Session expirée.",
        "unauthorized": "❌ Non autorisé.", "banned_msg": "🚫 Vous êtes banni.",
        "code_failed": "Échec de récupération du code", "error_service": "Service temporairement indisponible.",
        "invoice_expired": "Votre facture de dépôt a expiré",
        "start_over": "Touchez « Déposer » dans le Portefeuille pour en créer une nouvelle.",
    },
}
...
def t(key: str, lang: str = "en", **kwargs) -> str:
    pack = LANGUAGES.get(lang, LANGUAGES["en"])
    text = pack.get(key) or LANGUAGES["en"].get(key) or key
    if kwargs:
        try:
...
def start_health_server():
    ...
    try:
        with socketserver.TCPServer(("0.0.0.0",port),Handler) as httpd:
            print(f"[Health] Listening on port {port}",flush=True);httpd.serve_forever()
...
def prompt_custom_quantity(chat_id,user_id,code,lang="en"):
    try:
        ...
        text="\n".join([f"<b>{escape(c.name)} {get_flag_emoji(c.code)}</b>","",f"<b>{t('price_per_account',lang)}:</b> {money(sp)}",f"<b>{t('available_stock',lang)}:</b> {c.quantity:,}","",f"✏️ <b>{t('send_qty',lang)}:</b>{money(bal)}","",t('tap_deposit',lang)])
    send_or_edit(chat_id,text,{"inline_keyboard":rows})
...
def send_orders(chat_id,user_id,lang="en"):
    ...
    if not rows:
        send_or_edit(chat_id,f"{pemoji(PREMIUM_ORDERS_HEADER_ID,'📦')} <b>{t('no_orders',lang)}</b>\n\n{t('no_orders_desc',lang)}",back_keyboard(lang));return
    lines=[]
